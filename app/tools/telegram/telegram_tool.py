...
class TelegramTools(Toolkit):
    ...
    def send_message(self, message: str, parse_mode: str = "Markdown") -> str:
        """This function sends a message to the chat ID.

        :param message: The message to send.
        :param parse_mode: Message parsing mode ('Markdown' by default, can be None, 'Markdown', or 'MarkdownV2')
        ...
        response = self._call_post_method("sendMessage", json=payload)
        try:
